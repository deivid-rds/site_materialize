...
<head>
    ...
    <title>Gravatá - Acomodação</title>
</head>
...
<body>
    ...
    <!-- TÍTULO -->
    <h5 class="center">Tela de Acomodação</h5>

    <!-- Botão Nova Acomodação -->
    <div class="container">
        <a href="#modal1_novo" role="button" class="waves-effect waves-light btn modal-trigger"><i class="material-icons right">hotel</i>Nova Acomodação</a>
    </div>

    <!-- Modal Novo -->
    <div id="modal1_novo" class="modal modal-fixed-footer">

        <form id="form_acomodacao_novo" onsubmit="return false;">
            <div class="modal-content">
                <h5>Nova Acomodação</h5>
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <textarea name="descricao_novo" id="textarea" class="materialize-textarea" data-length="250"></textarea>
            ...
            <div class="modal-footer">
                ...
                <button id="btnCadastrar" onclick="cadastrar_acomodacao()" class="btn waves-effect waves-light center red" type="submit" value="Cadastrar" name="cadastrar">
                    Salvar
    ...
    <div id="modal1_editar" class="modal modal-fixed-footer">
        ...
        <form id="aco_edt" onsubmit="editar_acomodacao()">
            <div class="modal-content">
                ...
                <div class="row">
                    <div class="input-field">
                        <i class="material-icons prefix">account_circle</i>
                        <input name="titulo_edt" id="titulo_edt" type="text" required autofocus class="validate" data-length="50">
                        <label for="titulo_edt">Título</label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <i class="material-icons prefix">message</i>
                        <textarea name="descricao_edt" id="descricao_edt" class="materialize-textarea" data-length="250"></textarea>
                        <label for="descricao_edt">Descrição</label>
                    </div>
                </div>
                ...
                <div class="file-field input-field">
                    <div class="btn">
                        <span>Carregar imagem</span>
                        <input name="imagem_edt" id="imagem_edt" type="file" onchange="mostraPreview(this)">
    ...
    <template id="modelo_acom">
        <tr>
            ...
            <td>
                ...
                <a href="#" data-id="%COD%" data-nome="%TIT%" onclick="excluir(this)" role="button" class="waves-effect waves-light btn modal-trigger"><i class="material-icons right">delete</i>Excluir</a>
            </td>
    ...
    <script>
        M.AutoInit();
        listar_acomodacao();       // trazendo os dados do webservice
