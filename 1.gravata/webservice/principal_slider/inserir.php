...
if(isset($_POST['titulo_novo_slider'])){
    $titulo    = $_POST['titulo_novo_slider'];
    $descricao = $_POST['descricao_novo_slider'];

    $imagem_novo = $_FILES['imagem_novo_slider'] ?? null;
    ...
    $sql = "INSERT INTO principal_slider_tb VALUES(0, '$titulo', '$descricao', '$nome')";
    ...
    if ($resultado) {
        ...
        $resposta = ['erro' => 'Erro ao obter principal slider.'];
        print json_encode($resposta);
        exit;
    }
}